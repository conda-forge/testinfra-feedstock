About testinfra-feedstock
=========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/testinfra-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6719&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/testinfra-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `testinfra` can be installed with `conda`:
...
```
mamba install testinfra
```

It is possible to list all of the versions of `testinfra` available on your platform with `conda`:
...
```
mamba search testinfra --channel conda-forge
```
...
mamba repoquery search testinfra --channel conda-forge

# List packages depending on `testinfra`:
mamba repoquery whoneeds testinfra --channel conda-forge

# List dependencies of `testinfra`:
mamba repoquery depends testinfra --channel conda-forge
```
